package com.example.gd12_pdf_a_10636
...
import com.example.gd12_pdf_a_10636.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding!!.buttonSave.setOnClickListener{
            ...
            val kampus = binding!!.editTextCampus.text.toString()
    ...
    private fun createPDF(nama: String, umur: String, tlp: String, alamat: String, kampus: String) {
        val pdfPath = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS)
            .toString()
        val file = File(pdfPath, "pdf_10636.pdf")
        ...
        @SuppressLint("UseCompactLoadingForDrawables") val d = getDrawable(R.drawable.mantaray)
